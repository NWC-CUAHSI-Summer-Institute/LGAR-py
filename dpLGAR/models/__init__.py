...
class Initialization:
    ...
    def kaiming_normal_initializer(self, x) -> None:
        nn.init.kaiming_normal_(x, mode=self.cfg.models.fan, nonlinearity="sigmoid")

    def xavier_normal_initializer(self, x) -> None:
        nn.init.xavier_normal_(x, gain=self.cfg.models.gain)
    ...
    def get(self):
        init = self.cfg.models.initialization.lower()
